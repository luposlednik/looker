view: ent_tpv_summary {
  ...
  dimension: idt_acquirer {
    type: string
    sql:
        {% if _user_attributes['grant_level_eo'] == 'YES' %}
    ...
    group_label: "* Dados Sensiveis"
    link: {
      label: "Esta informação possui grant_level_eo  - Solicite Acesso aqui"
      url: "@{url_idm}"
  ...
  dimension: idt_acquirer_category {
    ...
    link: {
      label: "Datapedia"
      url: "@{url_datapedia}DAX-ENT_TPV_SUMMARY-IDT_ACQUIRER_CATEGORY"
      icon_url: "@{url_datapedia_ico}"
    }
  }
  ...
  dimension: num_bin_card {
    ...
    group_label: "* Dados Sensiveis"
    link: {
      label: "Esta informação possui grant_level_sb  - Solicite Acesso aqui"
      url: "@{url_idm}"
      icon_url: "@{url_idm_ico}"
    }
    link: {
  ...
  dimension: idt_safepay_creditor {
    type: string
    sql:
        {% if _user_attributes['grant_level_pii'] == 'YES' %}
    ...
    group_label: "* Dados Sensiveis"
    link: {
      label: "Esta informação possui grant_level_pii  - Solicite Acesso aqui"
      url: "@{url_idm}"
      icon_url: "@{url_idm_ico}"
    }
    link: {
  ...
  measure: num_tpv_value {
    type: sum
    sql:
        {% if _user_attributes['grant_level_ef'] == 'YES' %}
    ...
    group_label: "* Dados Sensiveis"
    link: {
      label: "Esta informação possui grant_level_ef  - Solicite Acesso aqui"
      url: "@{url_idm}"
      icon_url: "@{url_idm_ico}"
    }
    link: {
  ...
  dimension: num_net_cost_payware {
    ...
    link: {
      label: "Datapedia"
      url: "@{url_datapedia}DAX-ENT_TPV_SUMMARY-NUM_NET_COST_PAYWARE"
      icon_url: "@{url_datapedia_ico}"
    }
  }
  ...
  dimension: cod_card_category {
    type: string
    sql:
        {% if _user_attributes['grant_level_pci'] == 'YES' %}
    ...
    group_label: "* Dados Sensiveis"
    link: {
      label: "Esta informação possui grant_level_pci  - Solicite Acesso aqui"
      url: "@{url_idm}"
      icon_url: "@{url_idm_ico}"
    }
    link: {
