view: ent_customer_psp {
  ...
  #Adiciona validação de permissão de acesso para a tabela dentro de um explorer
  ...
  dimension: nam_leg_ent_trade {
    ...
    group_label: "Dados Empresariais"
    link: {
      label: "Datapedia"
